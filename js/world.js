/* World assembly — imports data, applies runtime state, contains animation logic */
...
import { WATER_Y, monument, fires as fireDefs, sheep as sheepDef, waterRocks as waterRockDefs, foamSpots as foamSpotDefs, clouds } from './data/terrain.js';

// Buildings — add runtime state (nameplateAlpha) to pure data
